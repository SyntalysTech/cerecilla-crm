...
import { ComisionablesCharts } from "./comisionables-charts";
...
interface DashboardChartsProps {
  ...
  provinciasMapData: Record<string, number>;
}
...
export function DashboardCharts({
  ...
  return (
    <>
      ...
      {/* Comisionables section with date filter */}
      <ComisionablesCharts
        initialServiciosData={serviciosData}
        initialProvinciasData={provinciasData}
        initialMapData={provinciasMapData}
      />
    </>
  );
}
